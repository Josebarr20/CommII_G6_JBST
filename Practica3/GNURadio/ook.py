...
class ook(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_add_const_vxx_0 = blocks.add_const_ff((-500e-3))
        ...
        self.connect((self.blocks_multiply_const_vxx_0_1, 0), (self.interp_fir_filter_xxx_0, 0))
        self.connect((self.blocks_multiply_const_vxx_0_1, 0), (self.qtgui_time_sink_x_0_0, 0))
