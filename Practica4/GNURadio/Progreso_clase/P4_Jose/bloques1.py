...
class bloques1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "bloques1")
        ...
        self.interp_fir_filter_xxx_1 = filter.interp_fir_filter_ccc(8, h)
        ...
        self.analog_noise_source_x_1 = analog.noise_source_c(analog.GR_GAUSSIAN, 0, 0)
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_null_sink_0_0, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_1, 0), (self.blocks_throttle_0_0, 0))
...
def main(top_block_cls=bloques1, options=None):
