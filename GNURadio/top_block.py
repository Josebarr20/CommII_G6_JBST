...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.tabla_de_verdad_constelacion = tabla_de_verdad_constelacion = (   -0.9487 + 0.9487j,
           -0.3162 + 0.9487j,
            0.3162 + 0.9487j,
            0.9487 + 0.9487j,
           -0.9487 + 0.3162j,
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, (K*Rs), 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, (K*Rs), 1, 0, 0)
    ...
    def set_Rs(self, Rs):
        ...
        self.set_Rb(self.Rs*self.bps)
        self.set_samp_rate(self.Rs*self.Sps)
        self.analog_sig_source_x_0.set_frequency((self.K*self.Rs))
        self.analog_sig_source_x_0_0.set_frequency((self.K*self.Rs))
